...
export default function AgentChart({ spec, onAddToView, refreshInterval }: { spec: ChartSpec; onAddToView?: (spec: ComponentSpec) => void; refreshInterval?: number }) {
  ...
  return (
    <div className="my-2 border border-slate-700 rounded-lg overflow-hidden bg-slate-900/50 min-w-0 h-full flex flex-col">
      ...
      <div className="p-2 flex-1" style={{ minHeight: height }}>
